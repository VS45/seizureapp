...
import { FiArchive, FiBarChart2, FiFileText, FiHome, FiLogOut, FiMapPin, FiPieChart, FiUserPlus, FiUsers } from 'react-icons/fi';
export default function AdminLayout({ children }) {
    ...
    const navItems = [
        ...
        { name: 'Seizures', href: '/admin/seizures', icon: <FiFileText size={20} /> },
        { name: 'Reports', href: '/admin/reports', icon: <FiBarChart2 size={20} /> },
