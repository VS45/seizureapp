...
export default function PatrolsPage() {
  ...
  const handleDeletePatrol = async (patrolId) => {
    try {
      const response = await fetch(`/api/patrols/${patrolId}`, {
        method: 'DELETE',
      });
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => router.push('/patrols/create')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 p-6">
            {filteredPatrols.map((patrol, index) => (
              <motion.div
                ...
                onClick={() => router.push(`/patrols/${patrol._id}`)}
              >
                {/* Patrol Header */}
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex space-x-1">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        router.push(`/patrols/${patrol._id}/edit`);
                      }}
